...
html+='<div class="page-title">Modernised PSP Design System</div>';
...
html+='</div>';
html+='<div class="card"><div class="card-title">Design Tokens</div><div class="swatch-grid">';
...
/* 1. MENTAL MODEL */
html+='<div class="sec">';
html+='<div class="page-title">PSP Payment Selection Hierarchy</div>';
...
/* 3. LAYOUT PATTERNS */
html+='<div class="sec">';
html+='<div class="page-title">Layout Patterns</div>';
html+='<div class="page-desc">Section grouping, spacing, and visual hierarchy rules for the PSP page layout.</div>';
...
/* 4. BOTTOM STICKY CTA */
html+='<div class="sec">';
html+='<div class="page-title">Bottom Sticky CTA Bar</div>';
html+='<div class="page-desc">Fixed-position bar at the bottom of the viewport. Contains savings influencer, order total, and primary action button.</div>';
html+='<div class="card"><div class="card-title">Full Bar Preview</div>';
...
html+='<div class="sec">';
html+='<div class="page-title">Character Constraints</div>';
...
/* 6. STATES REFERENCE */
html+='<div class="sec">';
html+='<div class="page-title">States Reference</div>';
html+='<div class="page-desc">All interactive states for instrument tiles and page-level elements.</div>';
...
/* 7. RAW JSON */
html+='<div class="sec">';
html+='<div class="page-title">Raw JSON</div>';
