...
html+='<div style="display:flex;align-items:center;gap:10px"><div style="width:48px;height:32px;border-radius:4px;display:flex;align-items:center;justify-content:center;flex-shrink:0;overflow:hidden"><img src="PSP Instument icons/Amazon Pay ICICI credit card.png" style="width:100%;height:100%;object-fit:contain"></div><div style="flex:1;min-width:0"><div style="margin-bottom:4px"><span style="background:#0A7CD1;color:#fff;font-size:10px;padding:2px 8px;border-radius:13px;display:inline-block">Best offer</span></div><div style="font-size:14px;font-weight:700;color:#0F1111">Amazon Pay ICICI credit card</div><div style="font-size:12px;color:#565959"><span style="color:#1A1F71;font-weight:700;font-size:10px;letter-spacing:1px">VISA</span> &#8226;&#8226;0424 | Akshay</div><div style="font-size:12px;color:#0B7B3C">Save &#8377;10 as cashback. <span style="color:#2162A1">Details</span></div></div><svg width="20" height="20" style="flex-shrink:0"><circle cx="10" cy="10" r="9" fill="none" stroke="#2162A1" stroke-width="2"/><circle cx="10" cy="10" r="5" fill="#2162A1"/></svg></div></div></div>';
...
html+='<div style="margin:0 12px;border-top:0.5px dashed #6F7373"></div>';
html+='<div style="padding:12px;position:relative"><div style="display:flex;align-items:center;gap:10px"><div style="width:48px;height:32px;border-radius:4px;display:flex;align-items:center;justify-content:center;flex-shrink:0;overflow:hidden"><img src="PSP Instument icons/HDFC Banks.png" style="width:100%;height:100%;object-fit:contain"></div><div style="flex:1;min-width:0"><div style="margin-bottom:4px"><span style="background:#E3E6E6;color:#232F3E;font-size:10px;padding:2px 8px;border-radius:13px;display:inline-block">Previously used</span></div><div style="font-size:14px;font-weight:400;color:#0F1111">HDFC credit card</div><div style="font-size:12px;color:#565959"><span style="color:#1A1F71;font-weight:700;font-size:10px;letter-spacing:1px">VISA</span> &#8226;&#8226;0422 | Akshay</div><div style="font-size:12px;color:#0B7B3C">Save &#8377;6. <span style="color:#2162A1">Details</span></div></div><svg width="20" height="20" style="flex-shrink:0"><circle cx="10" cy="10" r="9" fill="none" stroke="#D5D9D9" stroke-width="2"/></svg></div></div>';
html+='<div style="margin:0 12px;border-top:0.5px dashed #6F7373"></div>';
